"""
Combined step 3 -- AMP routing + B10 stable mask cache + S2 route update.

T6 step 2: preserve the measured v_router dispatch and add a CUDA fp16
autocast target for the three throughput-heavy shapes selected for the AMP
experiment (#6, #8, and #13). All other routes remain unchanged.
...
_ROUTE = {
    ...
    (64, 128, 128, 1):   "reduce",   # shape 9  -- 1.47x vs best 1.27x, compile 1.22x, reduce 1.21x
