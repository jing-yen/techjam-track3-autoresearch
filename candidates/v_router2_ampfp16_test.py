...
_IMPLS = {
    ...
    "amp_fp16": _AMPNativeFP16Transformer,
}
...
_ROUTE = {
    ...
    (64, 128, 128, 4):   "amp_fp16", # shape 1  -- PILOT: native fp16 weights instead of autocast.
    ...
    (128, 128, 128, 4):  "amp_fp16", # shape 5  -- PILOT, see shape 1's note.
    (10000, 128, 128, 4): "amp_fp16", # shape 6  -- PILOT, see shape 1's note. (source of the profiling finding)
    (64, 128, 32, 4):    "amp_fp16", # shape 7  -- PILOT, see shape 1's note.
    (64, 128, 1024, 4):  "amp_fp16", # shape 8  -- PILOT, see shape 1's note.
    ...
    (64, 128, 128, 16):  "amp_fp16", # shape 11 -- PILOT, see shape 1's note.
    (64, 32, 128, 4):    "fusedcg",  # shape 12 -- confirmed still best (11.09x)
    (64, 1024, 128, 4):  "amp_fp16", # shape 13 -- PILOT, see shape 1's note. (the biggest win, worth
